  ...
  return (
    <>
     <div className="tabs">
        ...
        <input type="radio" id="tab4" name="tab-control" value="Other Item" checked={selected === 'Other Item'} onChange={handleOptionChange}  />
        <ul>
          ...
          <li title="Pre Owned FolkLift"><label htmlFor="tab3" role="button"><svg viewBox="0 0 24 24">
              ...
              </svg><br /><span>Pre Owned FolkLift</span></label></li>    <li title="Other Items"><label htmlFor="tab4" role="button"><svg viewBox="0 0 24 24">
