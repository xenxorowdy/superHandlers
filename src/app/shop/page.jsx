  ...
  return (
    <>
     <div className="tabs">
        ...
        <input type="radio" id="tab4" name="tab-control"  value="Renatal FolkLift" checked={selected === 'Renatal FolkLift'} onChange={handleOptionChange}  />          
        ...
        <ul>
          ...
          <li title="Pre Owned FolkLift"><label htmlFor="tab3" role="button"><svg viewBox="0 0 24 24">
              ...
              <li title="Renatal FolkLift"><label htmlFor="tab4" role="button"> <FaTruckLoading/> <br /><span>Renatal FolkLift</span></label></li>
