...
export default function Login() {
  ...
  if(session){
    return (
      ...
      <p className=" flex text-[#3f4550] font-normal gap-10 text-3xl  align-baseline  items-center w-[240px]">Hello {session?.user?.name}</p> 
  ...
  <a href='/upload' >
  <p className=" flex text-[#3f4550] font-normal gap-10 align-baseline  items-center  w-[240px] text-xl"> <FaCloudUploadAlt className="h-4"/> upload <FaExternalLinkAlt className='h-4 '/> </p>
<figure>
<Image  src={'/wp7388677-forklift-wallpapers.jpg'} className=' aspect-[3/2] w-80 h-40' width={300} height={400} alt="Mountains" />
  ...
  <p className=" flex text-[#3f4550] font-normal gap-10 align-baseline  items-center   text-xl w-[240px]"><FaTrashAlt className="h-4"/>  delete <FaExternalLinkAlt className='h-4'/> </p>
<figure>
