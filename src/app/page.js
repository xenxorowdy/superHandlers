    ...
    <div className='flex-col gap-[2rem] flex'>
        ...
        {set &&
          <div className='flex gap-[2px]'>
            ...
            <div className='descriptiontext'>
              ...
              <Link className="subdis" href="/about">
      ...
      <div className='bodycard'>
        ...
        <a className='flex items-center flex-col' href='/about' >
          ...
          <p className=" flex text-[#3f4550] font-normal align-baseline  items-center   text-xl w-fit">About <FaExternalLinkAlt className='h-4' /> </p>
